...
const Products = () => {
    ...
    const fetchProducts = async ()=>{
        ...
        try {
            ...
            if(minPrice) params.set('category', minPrice)
                ...
                <main className="flex-1">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-sm text-app-text-light mt-0.5">{products.length}
                            products found</p>
                        </div>
                        ...
                        <div className="flex flex-col lg:items-center gap-3">
                            ...
                            flex items-center gap-2 px-3 py-2 text-sm bg-white rounded-xl
                            border bordr-app-border hover:bg-app-cream transition-colors">
                            ...
                            <div className="relative">
                                ...
                                bg-white rounded-xl border border-app-borde
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16">
                            ...
                            rounded-xl hover:bg-app-green-light transition-colors">Clear Filters
                            </button>
                        </div>
                    ) : (
