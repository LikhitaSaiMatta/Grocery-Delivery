        ...
        {/* Orders List */}
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <Link to="/products" className="inline-flex px-4 py-2 bg-app-green
                ...
                transition-all">
                  ...
                  <div className="flex items-center gap-2 mb-3 ">
                    {order.items.slice(0,4).map((item, i)=>(
                      ...
                      className="size-12 sm:size-16 rounded-lg objet-cover
                      border border-app-border" />
                    ))}
                    {order.items.length > 4 && <div className="size-12
                  ...
                  <div className="flex justify-between items-center pt-3">
                    ...
                    <span className="font-semibold text-app-green"> {currency}
