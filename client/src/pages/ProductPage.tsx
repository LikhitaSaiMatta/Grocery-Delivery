        ...
        <div className="bg-white/50 rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
              ...
              { product.discount > 0 && (
                <span className="px-2.5 py-1 text-xs font-semibold bg-app-orange
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                border-app-border rounded-xl overflow-hidden">
                  <button onClick={handleMinus} className="p-3 hover:bg-app-cream
                  transition-colors">
                  ...
                  <button onClick={handlePlus} className="p-3 hover:bg-app-cream
                  transition-colors">
          ...
          <section className="mt-12 mb-44">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                text-app-green">Related Products</h2>
