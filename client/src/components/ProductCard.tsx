  ...
  return (
        ...
        onClick={()=> navigate(`/products/${product._id}`)}>
            ...
            <div className="relative aspect-square overflow-hidden">
                ...
                object-cover p-4 group-hover:p-2 tranisition-all duration-300"/>
            ...
            <div className="p-3.5 text-zinc-700">
                ...
                {product.rating > 0 && (
                    <div className="flex items-center gap-1 mb-2">
                        ...
                        <span className="text-xs font-medium text-app-text">{product.
                        rating}</span>
                        <span className="text-xs text-app-text-light">({product.
                        reviewCount})</span>
                    </div>
                )}
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1 truncate">
                        <span className="text-base font-medium">{currency}{product.
                        price.toFixed(1)}
                        </span>
                        <span className="text-xs text-app-text-light block">/{product.
                        unit}</span>
