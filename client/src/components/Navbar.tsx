                    ...
                    <div className="relative">
                        ...
                        : (
                            <div className="flex-center gap-2">
                                ...
                                font-medium text-white bg-green-950 rounded-full
                        ...
                        {userMenuOpen && (
                            <>
                                ...
                                setUserMenuOpen(false)} />
                                <div className="absolute right-0 mt-2.5 w-5.6
                                ...
                                border-app-border py-2 z-50 animate-fade-in">
                                    ...
                                    {!user && <Link to='/login'
                                    className="dropdown-link"><UserIcon size={16} /
                                    > Sign In </Link>}
                                    ...
                                    md:hidden"><ArrowUpRightIcon size={16} />
                                    Products </Link>
                                    ...
                                    {user?.isAdmin && (
                                        ...
                                        <span className="text-app-orange-dark">Admin Panel
                                        </span> </Link>
                                    )}
                                    {user && (
